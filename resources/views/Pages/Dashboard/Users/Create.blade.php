    ...
    <x-accordion id="users-form" :collapse="false">
        ...
        <x-accordion.body id="datos-personales" parent="datos-personales">
            <div class="grid gap-4 sm:grid-cols-3 sm:gap-6">
                ...
                <div>
                    <x-form.input name="second_lastname" label="Apellido Materno" value="" :options="[
                        'placeholder' => 'Gómez',
                        'required' => 'true',
                    ]" />
                </div>
                ...
                <div>
                    {{-- ? Here goes the Select (which doesnt have a component yet)  --}}
                    Make the select component!
                </div>
                <div>
        ...
        <x-accordion.body id="credenciales-usuario" parent="credenciales-usuario" :positionLast="true">
            <div class="grid gap-4 sm:grid-cols-3 sm:gap-6">
                <div>
                    <x-form.input name="matricula" label="Matrícula" value=""
                        :options="[
                ...
                <div>
                    <x-form.input name="role" label="Rol" value="Alumno"
                        :options="[
                            'disabled' => 'true',
                            'readonly' => 'true'
                        ]" />
                ...
                <div>
                    <x-form.input name="email" label="Correo Electrónico" value=""
                        :options="[
                        ...
                        <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                            <div class="grid gap-4 sm:grid-cols-3 sm:gap-6">
                                ...
                                <div class="relative max-w-sm">
                                    ...
                                    <input id="birthday2" name="birthday" datepicker type="text"
