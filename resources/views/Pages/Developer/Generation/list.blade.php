...
@section('content')
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center" id="mainForm" action="{{ route('developer.generations.index') }}"
                            method="GET">
                            ...
                            <div class="relative w-full">
                                ...
                                <input type="hidden" id="hiddenGenerationDeactivated" name="hiddenGenerationDeactivated"
                                    value="0">
                            </div>
                        </form>
                    </div>
                    ...
                    <div
                        ...
                        <a type="button" data-modal-target="generations-create-modal"
                            data-modal-toggle="generations-create-modal"
                                ...
                                <ul class="space-y-2 text-sm" aria-labelledby="filterDropdownButton">
                                    <li class="flex items-center">
                                        <input id="SubjectDeactivated" name="SubjectDeactivated" type="checkbox"
                                            value="1"
                                            {{ request('hiddenGenerationDeactivated') == 1 ? 'checked' : '' }}
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            @foreach ($generations->items() as $g)
                                <tr class="border-b dark:border-gray-700">
                                    {{-- Generation Code --}}
                                    <th scope="row"
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <button id="{{ $g->code }}-dropdown-button"
                                            data-dropdown-toggle="{{ $g->code }}-dropdown"
                                        ...
                                        <div id="{{ $g->code }}-dropdown"
                                            class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                aria-labelledby="{{ $g->code }}-dropdown-button">
                                                {{-- Subject Edit Button --}}
                                                <li>
                                                    <button data-modal-target="generations-{{ $g->code }}-edit-modal"
                                                        data-modal-toggle="generations-{{ $g->code }}-edit-modal"
                                                        class="block w-full py-2 px-4 text-start hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</button>
                                                </li>
                                            </ul>
                                            @if ($g->trashed())
                                                <div class="py-1">
                                                    <form action="{{ route('developer.generations.restore', $g) }}"
                                                        method="POST">
                                                        @method('PUT')
                                                        @csrf
                                                        <button type="submit"
                                            ...
                                            @else
                                                <div class="py-1">
                                                    <form action="{{ route('developer.generations.destroy', $g) }}"
                                                        method="POST">
                                                        @method('DELETE')
                                                        @csrf
                                                        <button type="submit"
                ...
                <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
                    ...
                    <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                        Showing
                        <span
                            class="font-semibold text-gray-900 dark:text-white">{{ $generations->firstItem() }}-{{ $generations->lastItem() }}</span>
                        of
                        <span class="font-semibold text-gray-900 dark:text-white">{{ $generations->total() }}</span>
                    </span>
                    <ul class="inline-flex items-stretch -space-x-px">
                        ...
                        @else
                            <li>
                                <a href="{{ $generations->previousPageUrl() }}"
                        ...
                        @endif
                        @foreach ($generations->links()->elements['0'] as $label => $path)
                            @if ($label === $generations->currentPage())
                                <li>
                        ...
                        @if ($generations->hasMorePages())
                            <li>
                                <a href="{{ $generations->nextPageUrl() }}"
    ...
    @foreach ($generations as $g)
        <div id="generations-{{ $g->code }}-edit-modal" data-modal-placement="top-center" tabindex="-1"
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        ...
                        <button data-modal-toggle="generations-{{ $g->code }}-edit-modal" type="button"
                    ...
                    <!-- Modal body -->
                    <form class="p-4 md:p-5" action="{{ route('developer.generations.update', $g) }}" method="POST">
                        @method('PUT')
                        @csrf
                            ...
                            <div class="col-span-2">
                                ...
                                <div id="date-{{$g->code}}-range-picker" class="flex items-center">
                                    <div class="relative">
                                        ...
                                        <input id="datepicker-{{$g->code}}-range-start" datepicker datepicker-format="yyyy-mm-dd" name="start_date" type="text"
                                    ...
                                    <div class="relative">
                                        ...
                                        <input id="datepicker-{{$g->code}}-range-end" datepicker datepicker-format="yyyy-mm-dd" name="end_date" type="text"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        <div class="sm:hidden">
                            <span class="text-[0.6rem]  text-gray-500 dark:text-gray-400 text-center">* Al actualizar la
                                generación, se actualizarán todos los registros que poseian esta ultima. Aseguresé que lo
                                que
                        ...
                        <div id="edit_modal_mustread_{{ $g->code }}" role="tooltip"
                        ...
                        <button type="submit" data-tooltip-target="edit_modal_mustread_{{ $g->code }}"
    ...
    <div id="generations-create-modal" data-modal-placement="top-center" tabindex="-1"
        class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-md max-h-full">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button data-modal-toggle="generations-create-modal" type="button"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white">
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 14 14">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                ...
                <!-- Modal body -->
                <form class="p-4 md:p-5" action="{{ route('developer.generations.store') }}" method="POST">
                    @csrf
                    <div class="grid gap-4 grid-cols-2">
                        <div class="col-span-2">
                            <label for="edit_name"
                            ...
                            <div id="date-create-range-picker" class="flex items-center">
                                <div class="relative">
                                    ...
                                    <input id="datepicker-create-range-start" datepicker datepicker-format="yyyy-mm-dd" name="start_date" type="text"
                                ...
                                <div class="relative">
                                    ...
                                    <input id="datepicker-create-range-end" datepicker datepicker-format="yyyy-mm-dd" name="end_date" type="text"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-secondary-500 focus:border-secondary-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
