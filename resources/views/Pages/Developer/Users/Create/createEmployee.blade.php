...
@section('content')
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl">
            <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Agregar empleado</h2>
                            ...
                            <div class="grid gap-4 sm:grid-cols-3 sm:gap-6">
                                ...
                                <div>
                                    ...
                                    <select id="role" name="role" required=""
                                        ...
                                        <option value="DEV"
                                            @if (old('role') == 'DEV') {{ 'selected' }} @endif>Developer</option>
                                        <option value="ADM"
                                            @if (old('role') == 'ADM') {{ 'selected' }} @endif>Administrativo
                                        </option>
                                        <option value="DIR"
                                            @if (old('role') == 'DIR') {{ 'selected' }} @endif>Director</option>
                                        <option value="COO"
                                            @if (old('role') == 'COO') {{ 'selected' }} @endif>Coordinador
                                        </option>
                                        <option value="DOC"
                                            @if (old('role') == 'DOC') {{ 'selected' }} @endif>Docente</option>
                                    </select>
                                </div>
                                <div>
                                    <label for="email"
                                ...
                                <div id="div_cedula_profesional" class="hidden">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" id="cedula_profesional" name="cedula_profesional"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="12345678" value="{{ old('cedula_profesional') }}">
                                    </div>
                                </div>
    ...
    <script>
        const div_cedula_profesional = document.getElementById('div_cedula_profesional');
        ...
        if (accepted_roles.includes(select_role.value)) {
            div_cedula_profesional.classList.remove('hidden');
            input_cedula_profesional.disabled = false;
        }

        select_role.onchange = (event) => {
            console.log(select_role.value);
            if (accepted_roles.includes(select_role.value)) {
                div_cedula_profesional.classList.remove('hidden');
                input_cedula_profesional.disabled = false;
                input_cedula_profesional.required = true;
            } else {
                div_cedula_profesional.classList.add('hidden');
