<x-cards.card-template>
                ...
                <li class="py-3 sm:py-4">
                    <div class="flex items-center">
                        ...
                        <div id="{{ $s->slug }}-dropdown"
                            ...
                            @if ($s->trashed())
                                <div class="py-1">
                                    <form action="{{ route('login', $s) }}" {{-- developer.studyplans.restore --}} method="POST">
                                        @method('PUT')
                                        @csrf
                                        <button type="submit"
                            ...
                            @else
                                <div class="py-1">
                                    <form action="{{ route('login', $s) }}" {{-- developer.studyplans.destroy --}} method="POST">
                                        @method('DELETE')
                                        @csrf
                                        <button type="submit"
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <form class="p-4 md:p-5" action="{{ route('developer.studyplans.store') }}" method="POST">
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-4">
                        ...
                        <div class="col-span-2">
                            <label for="careercode_joined"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mínimo aprobatorio</label>
                            <input type="number" id="studyplan-create-modal-PassingGrade"
                                name="passing_grade"
                        ...
                        <div class="col-span-4 inline-flex gap-4 text-center">
                            ...
                            <input type="number" id="studyplan-create-modal-RVOENo"
                                name="rvoe_number"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="285" required min="0" />
                            <p class="mb-2 text-3xl font-medium text-gray-900 dark:text-white">/</p>
                            <input type="number" id="studyplan-create-modal-RVOEYear"
                                name="rvoe_year"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
    ...
    <div data-modal-target="studyplan-edit-modal-{{$s->slug}}" id="studyplan-edit-modal-{{$s->slug}}" tabindex="-1" aria-hidden="true"
        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-md max-h-full">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-4">
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="number" id="studyplan-create-modal-PassingGrade"
                                name="passing_grade"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="60" required min="50" max="100" value="{{$s->passing_grade}}"
                                title="Please enter a valid number (50-100)" />
                        </div>
                        <div class="col-span-4 inline-flex gap-4 text-center">
                            <p class="mb-2 text-sm font-medium text-gray-900 dark:text-white">RVOE no.</p>
                            <input type="number" id="studyplan-create-modal-RVOENo"
                                name="rvoe_number"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="285" required min="0" value="{{(int)$s->RVOENumbers['number']}}" />
                            <p class="mb-2 text-3xl font-medium text-gray-900 dark:text-white">/</p>
                            <input type="number" id="studyplan-create-modal-RVOEYear"
                                name="rvoe_year"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="2013" required min="2000" max="2099" value="{{$s->RVOENumbers['year']}}"
                                title="Please enter a valid year (2000-2099)" />
                        </div>
