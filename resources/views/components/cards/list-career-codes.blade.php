<x-cards.card-template>
    ...
    <div
        ...
        <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
            @foreach ($codes as $career)
                @foreach ($career->careerCodes as $c)
            ...
            <div id="careercode-{{ $c->joined }}-edit-modal" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <!-- Modal body -->
                        <form class="p-4 md:p-5" action="{{ route('developer.careercodes.update', $c) }}"
                            method="POST">
                            @method('PUT')
                            @csrf
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            <label for="create_career_name"
                                ...
                                de la carrera</label>
                            <input disabled readonly value="{{ $codes[0]->name }}" type="text"
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            <label for="create_career_abbreviation" max="3"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Abreviación
                                carrera</label>
                            <input readonly value="{{ $codes[0]->abbreviation }}" type="text"
