 ...
 * Users routes
 */
Route::prefix('dashboard/developer/users')->middleware('auth', 'role:DEV')->group(fn () => [
 ...
 */
Route::prefix('dashboard/developer/users/create')->middleware('auth', 'role:DEV')->group(fn () => [
 ...
 */
Route::prefix('dashboard/developer/users/edit')->middleware('auth', 'role:DEV')->group(fn () => [
 ...
 * Showing Users
 */
Route::prefix('dashboard/developer/users/show')->middleware('auth', 'role:DEV')->group(fn () => [
